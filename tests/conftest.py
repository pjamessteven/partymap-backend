...
def emailer():
    ...
    the mail that would've been sent. Because this extension is tied to the "app", and the
    app lives for the duration of the test session, this mail_sent count accumulates
    across test boundaries and so must be reset between tests to give an accurate count of
    mail sent for each test.
    """
