...
function JetpackLikesMessageListener( event, message ) {
	...
	allowedOrigin = window.location.protocol + '//web.archive.org/web/20171007162017/https://widgets.wp.com/';
...
jQuery( function() {
	...
	$( 'body' ).on( 'click', 'a.comment-like-link', function( $e ) {
		if ( $( $e.target ).hasClass( 'needs-login' ) ) {
			...
			var url = 'https://web.archive.org/web/20171007162017/https://wordpress.com/public.api/connect/?action=request&service=wordpress';
			...
			loginIframe.attr( "src", "https://web.archive.org/web/20171007162017/https://wordpress.com/public.api/connect/?iframe=true" );
...
(function($){
	...
	if ( ! fbd.canCustomizeSite ) {
		// Report Link
		reporthtml = '<li class="flb-report"><a href="https://web.archive.org/web/20171007162017/http://en.wordpress.com/abuse/">' + fbd.i18n.report + '</a></li>';
	}
	...
	if ( fbd.isLoggedIn ) {
		...
		if ( fbd.canFollow ) {
			if ( fbd.isSingular ) {
				viewReaderHtml = '<li class="actnbr-reader"><a href="https://web.archive.org/web/20171007162017/https://wordpress.com/read/blogs/' + fbd.siteID + '/posts/' + fbd.postID +'">' + fbd.i18n.viewReadPost + '</a></li>';
			} else {
				viewReaderHtml = '<li class="actnbr-reader"><a href="https://web.archive.org/web/20171007162017/https://wordpress.com/read/' + ( fbd.feedID ? 'feeds/' + fbd.feedID : 'blogs/' + fbd.siteID ) + '">' + fbd.i18n.viewReader + '</a></li>';
			}
		}
		editFollowsHtml = '<li class="actnbr-follows"><a href="https://web.archive.org/web/20171007162017/https://wordpress.com/following/edit">' + fbd.i18n.editSubs + '</a></li>';
	} else {
		...
		editSubsHtml = '<li class="actnbr-subs"><a href="https://web.archive.org/web/20171007162017/https://subscribe.wordpress.com/">' + fbd.i18n.editSubs + '</a></li>';
	}
	...
	function showActionBarFollowForm() {
		...
		form.attr('action', 'https://web.archive.org/web/20171007162017/https://subscribe.wordpress.com/');
...
wpcom.carousel = (function(/*$*/) {
	...
	var stat = function ( names ) {
		...
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20171007162017/https://pixel.wp.com/g.gif?v=wpcom-no-pv' +
			'&x_carousel=' + names +
			'&baba=' + Math.random();
	};
	...
	var pageview = function ( post_id ) {
		new Image().src = window.location.protocol +
			'//web.archive.org/web/20171007162017/https://pixel.wp.com/g.gif?host=' + encodeURIComponent( window.location.host ) +
...
// @end-hide-in-jetpack
			...
			container.attr('itemtype', 'https://web.archive.org/web/20171007162017/https://schema.org/ImageGallery');
...
// @end-hide-in-jetpack
			...
			items.each(function(i){
				...
				if ( attachment_id && orig_size.length ) {
					...
					var slide = $('<div class="jp-carousel-slide" itemprop="associatedMedia" itemscope itemtype="https://web.archive.org/web/20171007162017/https://schema.org/ImageObject"></div>')
							.hide()
							.css({
								//'position' : 'fixed',
...
// @end-hide-in-jetpack
		...
		updateMap: function( meta ) {
			...
			$mapbox
				...
				.html( '<img width="154" height="154" src="https://web.archive.org/web/20171007162017/https://maps.googleapis.com/maps/api/staticmap?\
							...
							\
						<div class="gmap-topright"><div class="imgclip"><img width="175" height="154" src="https://web.archive.org/web/20171007162017/https://maps.googleapis.com/maps/api/staticmap?\
							center=' + latitude + ',' + longitude + '&\
							zoom=3&\
							size=175x154&\
							sensor=false&\
...
if ( sharing_js_options && sharing_js_options.counts ) {
	var WPCOMSharing = {
		...
		get_counts : function() {
			...
			for ( url in WPCOM_sharing_counts ) {
				...
				requests = {
					...
					linkedin: [
						'https://web.archive.org/web/20171007162017/https://www.linkedin.com/countserv/count/share?format=jsonp&callback=WPCOMSharing.update_linkedin_count&url=' +
							encodeURIComponent( url )
					],
					// Pinterest, like LinkedIn, handles share counts for both http and https
					pinterest: [
						window.location.protocol +
							'//web.archive.org/web/20171007162017/https://api.pinterest.com/v1/urls/count.json?callback=WPCOMSharing.update_pinterest_count&url=' +
							encodeURIComponent( url )
					],
					// Facebook protocol summing has been shown to falsely double counts, so we only request the current URL
					facebook: [
						window.location.protocol +
							'//web.archive.org/web/20171007162017/https://graph.facebook.com/?callback=WPCOMSharing.update_facebook_count&ids=' +
							encodeURIComponent( url )
					]
				};
		...
		bump_sharing_count_stat: function( service ) {
			new Image().src = document.location.protocol + '//web.archive.org/web/20171007162017/https://pixel.wp.com/g.gif?v=wpcom-no-pv&x_sharing-count-request=' + service + '&r=' + Math.random();
		}
	};
}
...
0)c="http://"+c.substring(8);b=b.server+"/img/audiocaptcha.swf?v2";a=a._is_ie()?'<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" id="audiocaptcha" width="0" height="0" codebase="https://web.archive.org/web/20171007162017/https://fpdownload.macromedia.com/get/flashplayer/current/swflash.cab"><param name="movie" value="'+b+'" /><param name="quality" value="high" /><param name="bgcolor" value="#869ca7" /><param name="allowScriptAccess" value="always" /></object><br/>':'<embed src="'+b+'" quality="high" bgcolor="#869ca7" width="0" height="0" name="audiocaptcha" align="middle" play="true" loop="false" quality="high" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="https://web.archive.org/web/20171007162017/http://www.adobe.com/go/getflashplayer"></embed> ';
...
/*
     FILE ARCHIVED ON 16:20:17 Oct 07, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 22:36:16 Dec 22, 2019.
...
/*
playback timings (ms):
  PetaboxLoader3.datanode: 172.584 (5)
  esindex: 0.01
  exclusion.robots.policy: 0.176
  RedisCDXSource: 19.493
  captures_list: 306.132
  CDXLines.iter: 46.669 (3)
  load_resource: 370.686
  PetaboxLoader3.resolve: 293.749 (2)
  exclusion.robots: 0.189
  LoadShardBlock: 236.434 (3)
*/