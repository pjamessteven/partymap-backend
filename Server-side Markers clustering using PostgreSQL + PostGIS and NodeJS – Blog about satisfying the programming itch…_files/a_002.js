...
var HighlanderComments = jQuery.extend( HighlanderComments, {
	...
	init : function() {
		...
		pm.bind( 'googlePlusButtonClick', HighlanderComments.onGooglePlusButtonClick, 'https://web.archive.org/web/20171012215842/https://public-api.wordpress.com/' );
		pm.bind( 'googlePlusSignIn', HighlanderComments.onGooglePlusSignIn, 'https://web.archive.org/web/20171012215842/https://public-api.wordpress.com/' );
		...
		jQuery( 'textarea#comment' )
			...
			.one( 'focus', function() {
				...
				pm( {
					...
					data: 0,
					url: 'https://web.archive.org/web/20171012215842/https://public-api.wordpress.com/'
				} );
			});
...
//		HighlanderComments.autosaveComment();
	...
	updateAvatarWithGravatar: function(e) {
		var grav_base = ( 'https:' === location.protocol ? 'https://web.archive.org/web/20171012215842/https://secure/' : 'https://web.archive.org/web/20171012215842/http://www/' ) + '.gravatar.com/avatar/';
			...
			jQuery( '#comment-form-' + service + ' .comment-form-avatar img' )
				.attr( 'src', function() {
					...
					try {
						...
						url = location.protocol + '//web.archive.org/web/20171012215842/https://i0.wp.com/' + host + '/' + path + '?';
	...
	doExternalCanceled : function( service, from_tab ) {
		if ( from_tab ) {
			var gravSource = ( 'https:' === location.protocol ? 'https://web.archive.org/web/20171012215842/https://secure/' : 'https://web.archive.org/web/20171012215842/http://www/' ) + '.gravatar.com/avatar/ad516503a11cd5ca435acc9bb6523536?s=25';
			if ( 'gravatar_default' !== HighlanderComments.gravDefault ) {
				gravSource += '&d=' + encodeURIComponent( HighlanderComments.gravDefault );
			}
	...
	doExternalLogout : function( service ) {
		...
		if ( 'googleplus' == service ) {
			jQuery( 'body' ).append( '<iframe height="1" width="1" style="display:none;" src="https://web.archive.org/web/20171012215842/https://accounts.google.com/logout" />' );
		}
	},
...
/*
playback timings (ms):
  load_resource: 224.011
  exclusion.robots.policy: 0.196
  CDXLines.iter: 77.384 (3)
  exclusion.robots: 0.212
  RedisCDXSource: 0.733
  PetaboxLoader3.datanode: 328.423 (8)
  LoadShardBlock: 274.827 (6)
  esindex: 0.014
  PetaboxLoader3.resolve: 126.263 (2)
*/