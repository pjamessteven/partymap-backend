...
Revision ID: 5e6b64586378
Revises:
Create Date: 2020-08-03 13:57:17.525059
...
def upgrade():
    ...
    sa.Column('event_start', sa.DateTime(), autoincrement=False, nullable=True),
    sa.Column('event_start_naive', sa.DateTime(), autoincrement=False, nullable=True),
    sa.Column('event_end', sa.DateTime(), autoincrement=False, nullable=True),
    sa.Column('event_end_naive', sa.DateTime(), autoincrement=False, nullable=True),
    sa.Column('all_day', sa.Boolean(), autoincrement=False, nullable=True),
    sa.Column('location_id', sa.String(), autoincrement=False, nullable=True),
    ...
    op.create_table('event_owners_version',
    sa.Column('event_id', sa.Integer(), autoincrement=False, nullable=True),
    ...
    op.create_index(op.f('ix_event_owners_version_end_transaction_id'), 'event_owners_version', ['end_transaction_id'], unique=False)
    op.create_index(op.f('ix_event_owners_version_operation_type'), 'event_owners_version', ['operation_type'], unique=False)
    op.create_index(op.f('ix_event_owners_version_transaction_id'), 'event_owners_version', ['transaction_id'], unique=False)
    ...
    sa.Column('default_location_place_id', sa.String(), autoincrement=False, nullable=True),
    ...
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['default_location_place_id'], ['event_locations.place_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['location_id'], ['event_locations.place_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('event_contribution_id', sa.Integer(), nullable=True),
    ...
    sa.Column('user_id', sa.Integer(), nullable=True),
    sa.Column('event_image_id', sa.Integer(), nullable=True),
    ...
    sa.ForeignKeyConstraint(['creator_id'], ['users.id'], ),
    sa.ForeignKeyConstraint(['event_contribution_id'], ['event_contributions.id'], ),
    sa.ForeignKeyConstraint(['event_date_id', 'event_artist_artist_name'], ['event_artists.event_date_id', 'event_artists.artist_name'], ),
    sa.ForeignKeyConstraint(['event_date_id'], ['event_dates.id'], ),
    sa.ForeignKeyConstraint(['event_id', 'event_tag_tag_id'], ['event_tags.event_id', 'event_tags.tag_id'], ),
    sa.ForeignKeyConstraint(['event_id'], ['events.id'], ),
    sa.ForeignKeyConstraint(['event_image_id'], ['event_images.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
...
def downgrade():
    ...
    op.drop_index(op.f('ix_event_owners_version_transaction_id'), table_name='event_owners_version')
    op.drop_index(op.f('ix_event_owners_version_operation_type'), table_name='event_owners_version')
    op.drop_index(op.f('ix_event_owners_version_end_transaction_id'), table_name='event_owners_version')
    op.drop_table('event_owners_version')
