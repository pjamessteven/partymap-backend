...
Revision ID: a261445b82a1
Revises: f5736703dad0
Create Date: 2021-07-15 21:21:53.795726
...
revision = "a261445b82a1"
down_revision = "f5736703dad0"
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("events_version", "updated_at")
