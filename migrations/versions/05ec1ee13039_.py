...
Revision ID: 05ec1ee13039
Revises:
Create Date: 2021-04-12 23:10:57.546093
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "event_start_naive", sa.DateTime(), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "default_location_place_id", sa.String(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "settings",
