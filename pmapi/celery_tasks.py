...
def update_event_translation(event_id):
    ...
    if event:
        event.description_translations = update_translation_field(
            event.description_translations, event.description
        )
...
def update_event_date_translation(id):
    ...
    event_date.description_translations = update_translation_field(
        event_date.description_translations, event_date.description
    )
    db.session.commit()
...
def update_artist_translation(id):
    ...
    if artist.disambiguation:
        artist.description_translations = update_translation_field(
            artist.disambiguation_translations, artist.disambiguation
        )
    if artist.description:
        artist.description_translations = update_translation_field(
            artist.description_translations, artist.description
        )
    db.session.commit()
...
def update_review_translation(id):
    ...
    review.text_translations = update_translation_field(
        review.text_translations, review.text
    )
    db.session.commit()
