...
event_location_type_association = db.Table('event_location_type_association',
                                           db.Column('type', db.String, db.ForeignKey(
                                               'event_location_types.type')),
                                           db.Column('place_id', db.String, db.ForeignKey(
...
class EventLocationType(db.Model):
    ...
    event_locations = db.relationship(
        'EventLocation', secondary="event_location_type_association", back_populates="types")
...
class EventLocation(db.Model):
    ...
    types = db.relationship(
        'EventLocationType', secondary="event_location_type_association", back_populates="event_locations")
