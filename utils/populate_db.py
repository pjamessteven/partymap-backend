...
class Populate(Command):
    ...
    def run(self):
        ...
        for x in range(10000):
            ...
            event_end = datetime.fromtimestamp(event_start_timestamp + 1000000) # add about 12 days
            ...
            event = Event(name=random.choice(tags),
            creator_id=1,
            ...
            for x in range(0, random.randint(0,10)):
                ...
                if db.session.query(EventTag).filter(EventTag.tag==tag, EventTag.event==event).count():
